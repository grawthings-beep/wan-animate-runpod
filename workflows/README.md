...
- `wan22_smooth_v6_seamless_loop_auto_mosaic_runpod.json`: 通常ループのRIFE後・MP4化前にCPU自動モザイクを適用する別preset
- `wan22_smooth_v6_seamless_loop_batch10_auto_mosaic_runpod.json`: 10本逐次版の各完成動画へCPU自動モザイクを適用し、モザイク済み10本をZIP化
